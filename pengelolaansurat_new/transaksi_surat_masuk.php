            ...
            if(isset($_REQUEST['act'])){
                ...
                switch ($act) {
                    ...
                    case 'detail':
                        ...
                        break;
                    case 'tindakan':
                        include "tindakan_surat_masuk.php";
                        break;
                        case 'detailtindakan':
                        include "detailtindakan_surat_masuk.php";
                        break;
                    case 'disp':
                ...
                <?php
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      ...
                                      <tr>
                                        ...
                                        if(!empty($row['file'])){
                                            ...
                                            echo '<em>Tidak ada file yang di upload</em>';
                                        } if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==0) {
                                            echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Sudah Divalidasi Sekretaris</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                               <i class="material-icons">print</i> PRINT</a>
                                        ...
                                        }elseif ($row['approval_sekretaris']==2 and $row['approval_superadmin']==0) {
                                            echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Surat Anda Ditolak Oleh Sekretaris</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                               <i class="material-icons">print</i> PRINT</a>
                                    ...
                                    }elseif ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and  $row['status_feedback'] == 0 ) {
                                           echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Surat Belum Diperiksa</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        
                                        <a class="btn small blue darken-3 waves-effect waves-light" href="?page=tsm&act=tindakan&id_surat='.$row['id_surat'].'" >
                                               <i class="material-icons">edit</i> PRINT</a>
                                        <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                               <i class="material-icons">print</i> PRINT</a>
                                        ...
                                        }elseif ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and  $row['status_feedback'] == 1 ) {
                                           echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Surat Sudah Diperiksa</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        ...
                                        elseif ($row['approval_sekretaris']==0 and $row['approval_superadmin']==0) {
                                           echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Divalidasi Oleh Sekretaris</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                               <i class="material-icons">print</i> PRINT</a>
                    ...
                    <!-- Row form END -->';
                                   ...
                                   $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where approval_superadmin=0 and approval_sekretaris=1 or status_feedback = 1 or status_feedback = 0 ORDER by id_surat DESC LIMIT $curr, $limit ");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        if(!empty($row['file'])){
                                            echo ' <strong><a href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">'.$row['file'].'</a> <br> File Feedback : <a href="?page=gsm&act=fdsm&id_surat='.$row['id_surat'].'">'.$row['file_feedback'].'</a></strong>';
                                        } else {
                                            echo '<em>Tidak ada file yang di upload</em>';
                                        } if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==0) {
                                            echo '</td>
                                            <td>'.$row['asal_surat'].'</td>
                                            <td>Sudah Divalidasi Oleh Sekretaris</td>
                                            <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                            <td>
                                        ...
                                        }else if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1  and $row['status_feedback'] == 1 ) {
                                            echo '</td>
                                            <td>'.$row['asal_surat'].'</td>
                                            <td>Sudah Diperiksa User</td>
                                            <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                            <td>
                                            <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">edit</i> EDIT</a>
                                                <a class="btn small green darken-3 waves-effect waves-light" href="?page=tsm&act=detailtindakan&id_surat='.$row['id_surat'].'" ><i class="material-icons">search</i> PRINT</a>
                                                <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                                    <i class="material-icons">print</i> PRINT</a>
                                                <a class="btn small deep-orange waves-effect waves-light" href="?page=tsm&act=del&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">delete</i> DEL</a>
                                        ...
                                        else if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1  and $row['status_feedback'] == 0 ) {
                                            echo '</td>
                                            <td>'.$row['asal_surat'].'</td>
                                            <td>Belum Diperiksa User</td>
                                            <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                            <td>
                                            <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">edit</i> EDIT</a>
                    ...
                    <!-- Row form END -->';
                                   ...
                                   $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where approval_sekretaris = 0 and approval_superadmin=0 ORDER by id_surat DESC LIMIT $curr, $limit ");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        if(!empty($row['file'])){
                                            ...
                                            echo '<em>Tidak ada file yang di upload</em>';
                                        } if ($row['approval_sekretaris']==0 and $row['approval_superadmin']==0) {
                                            echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Divalidasi Sekretaris</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
                                           <a class="btn small green waves-effect waves-light" href="?page=tsm&act=detail&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">search</i> Detail</a>
                                            <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>
                                            <a class="btn small deep-orange waves-effect waves-light" href="?page=tsm&act=del&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">delete</i> DEL</a>
                    ...
                    <!-- Row form END -->';
                                   ...
                                   $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where approval_superadmin=0 and approval_sekretaris=1 ORDER by id_surat DESC LIMIT $curr, $limit ");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
