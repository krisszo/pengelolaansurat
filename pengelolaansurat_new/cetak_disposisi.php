    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jl.17 agutus no. 67 </span>';
            ...
            <div id="lead">
                ...
                <div style="height: 50px;"></div>';
                $query = mysqli_query($config, "SELECT kaban, nip FROM tbl_instansi");
                list($kaban,$nip) = mysqli_fetch_array($query);
                if(!empty($kaban)){
                    echo '<p class="lead">'.$kaban.'</p>';
                } else {
                    echo '<p class="lead">Olvie Atteng</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
