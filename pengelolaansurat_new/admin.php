...
Date        : 2022
Developer   : Michael Tumewu,Christian Katuuk Kominfo,Cristafael Kandou Bapenda Sulut,Efraim Dahlan Kaur 
            : Desa Tombulu,Natanhia Mangundap Ibu Sek Bapenda
Phone/WA    : 0897-9522-870
Email       : s21910441@student.unklab.ac.id
Website     : https:/bapenda.sulutprov.go.id
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                ...
                                echo "<strong>Administrator</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                                 ...
                                 echo "<strong>Sekretaris</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            }  
                            ?></p>
                    </div>
                </div>
